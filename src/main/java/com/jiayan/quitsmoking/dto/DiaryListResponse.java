...
public class DiaryListResponse {
    ...
    public DiaryListResponse(Integer code, String message, List<DiaryListItem> data) {
        this.code = code;
    ...
    public List<DiaryListItem> getData() { return data; }
    public void setData(List<DiaryListItem> data) { this.data = data; }
